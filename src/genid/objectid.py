...
"""Tools for working with MongoDB [ObjectIds](http://dochub.mongodb.org/core/objectids).

Taken from https://github.com/py-bson/bson
"""
...
class FixedOffset(datetime.tzinfo):
    ...
    def __init__(self, offset: t.Union[int, datetime.timedelta], name: str) -> None:
    ...
    def __getinitargs__(self) -> t.Tuple[datetime.timedelta, str]:
        return self.__offset, self.__name

    def utcoffset(self, dt: t.Any) -> datetime.timedelta:
        return self.__offset

    def tzname(self, dt: t.Any) -> str:
        return self.__name

    def dst(self, dt: t.Any) -> datetime.timedelta:
        return ZERO
...
def _fnv_1a_24(data: t.Iterable[int]) -> int:
    """FNV-1a 24 bit hash"""
...
def _raise_invalid_id(oid: t.Any) -> None:
    raise InvalidId(
...
class ObjectID(object):
    ...
    def __init__(self, oid: t.Union[str, bytes, "ObjectID", None] = None):
    ...
    def __validate(self, oid: t.Any) -> None:
